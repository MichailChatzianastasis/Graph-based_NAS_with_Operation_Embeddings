...
DEFINE_string("output_dir", '%s/../../outputs_6' % os.path.dirname(os.path.realpath(__file__)), "") #path

DEFINE_string("data_format", "NCHW""", "'NHWC' or 'NWHC' or  'NCWH'")
...
DEFINE_integer("child_num_layers", 6, "") #12 for 12layers
...
DEFINE_string("structure_path", "sample_structures6.txt", "")  #sample_structures12 for 12-layer
